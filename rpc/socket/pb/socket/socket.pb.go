...
type ReqBroadcastMsg struct {
	...
	AutoToken    string     `protobuf:"bytes,4,opt,name=autoToken,proto3" json:"autoToken,omitempty"`
...
func (x *ReqBroadcastMsg) GetAutoToken() string {
	if x != nil {
		return x.AutoToken
	}
	return ""
...
var file_socket_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x6f, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x75, 0x74, 0x6f, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12,
